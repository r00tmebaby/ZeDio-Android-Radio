    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) throws ArrayIndexOutOfBoundsException{
        ...
        holder.radioViewLayout.setOnClickListener(v -> {
            ...
            Radio newRadio = new Radio(
                    currentRadio.getRadioName(),
                    currentRadio.getRadioGenre(),
                    currentRadio.getRadioCountry(),
                    currentRadio.getRadioUrl(),
                    currentRadio.getRadioLogo());
            ActionChains playback = new ActionChains(mContext,newRadio);
            playback.playRadio();
        });
    }
